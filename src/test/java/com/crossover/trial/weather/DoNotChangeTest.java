...
import com.crossover.trial.weather.resources.CollectorAirportResource;
import com.crossover.trial.weather.resources.CollectorResource;
import com.crossover.trial.weather.resources.WeatherQueryResource;
...
public class DoNotChangeTest {
    ...
    private CollectorResource collector;

    private CollectorAirportResource collectorAirport;

    private WeatherQueryResource queryEndpoint;
    ...
    private void validateInterfaceWeatherCollector() {
        ...
        Class<CollectorAirportResource> resourceClass = collector.collectorAirportSubResource();
    }
    ...
    private void validateInterfaceAirportCollector() {
        ...
        Response getAirportResp = collectorAirport.getAirport((String) null);

        Response addAirportResp = collectorAirport.addAirport((String) null, (String) null, (String) null);

        Response deleteAirportResp = collectorAirport.deleteAirport((String) null);
    }
